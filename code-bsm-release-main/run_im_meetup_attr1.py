...
num_nodes, _, graph = read_file("C:/Users/hp/Downloads/code-bsm-release-main/data/meetup/meetup_edges.txt", is_dir=False)
attrs, groups = read_attr('C:/Users/hp/Downloads/code-bsm-release-main/data/meetup/meetup_attr.txt')
output_file = open('C:/Users/hp/Downloads/code-bsm-release-main/im_results_meetup-attr1.csv', 'a')
